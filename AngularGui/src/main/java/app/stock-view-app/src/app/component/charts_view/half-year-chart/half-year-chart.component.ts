...
@Component({
  selector: 'app-half-year-chart',
  templateUrl: './half-year-chart.component.html',
  styleUrls: ['./half-year-chart.component.css']
})
export class HalfYearChartComponent implements OnInit {
    ...
    this.source =
      {
        ...
        url: environment.springServerUrl + '/v1/stock/data/charts/halfyear?symbol='.concat(this.symbol)
      };
