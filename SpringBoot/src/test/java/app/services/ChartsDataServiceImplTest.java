...
class ChartsDataServiceImplTest {
    ...
    void getWeekDataShouldGetFromMongo() {
        when(mongoDataService.getStockData(TimeSeries.WEEKLY, SYMBOL)).thenReturn(prepareStockData());
    ...
    void getWeekDataShouldGetFromService() {
        when(mongoDataService.getStockData(TimeSeries.WEEKLY, SYMBOL)).thenReturn(Optional.empty());
    ...
    void getMonthDataShouldGetFromMongo() {
        when(mongoDataService.getStockData(TimeSeries.DAILY, SYMBOL)).thenReturn(prepareStockData());
    ...
    void getMonthDataShouldGetFromService() {
        when(mongoDataService.getStockData(TimeSeries.DAILY, SYMBOL)).thenReturn(Optional.empty());
    ...
    void getSixMonthsShouldGetDataFromMongo() {
        when(mongoDataService.getStockData(TimeSeries.MONTH, SYMBOL)).thenReturn(prepareStockData());
    ...
    void getSixMonthsDataShouldGetFromService() {
        when(mongoDataService.getStockData(TimeSeries.MONTH, SYMBOL)).thenReturn(Optional.empty());
    ...
    void getLastYearDataShouldGetFromMongo() {
        when(mongoDataService.getStockData(TimeSeries.YEAR, SYMBOL)).thenReturn(prepareStockData());
    ...
    void getLastYearDataShouldGetFromService() {
        when(mongoDataService.getStockData(TimeSeries.YEAR, SYMBOL)).thenReturn(Optional.empty());
    ...
    void getWeekDataShouldGetNoResult() {
        when(mongoDataService.getStockData(any(), any())).thenReturn(Optional.empty());
